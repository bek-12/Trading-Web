  ...
  return (
    <div className="mobile-topbar">
      ...
      <div style={{ display: 'flex', flexDirection: 'column' }}>
        ...
        {activeAccount && (
          <span style={{ fontSize: 11, color: 'var(--text-muted)', marginTop: 1 }}>{activeAccount.name}</span>
        )}
      </div>
    </div>
  );
...
function FAB() {
  ...
  // Hide FAB on the new-trade page itself
    ...
    <div style={{ maxWidth: 520 }}>
      <div style={{ marginBottom: 24 }}>
        ...
        <p style={{ color: 'var(--text-muted)', lineHeight: 1.7 }}>
          Your personal trading journal and accountability system. Set up your first account to get started.
        </p>
      </div>
      <div className="alert alert-blue" style={{ marginBottom: 24 }}>
        📋 Create an account to get started. We'll pre-fill it with example values so you can see how it works.
      </div>
